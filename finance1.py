...
if st.session_state['logged_in']:
    ...
    with tab1:
        ...
        col1.markdown(f"""
            <div style="text-align: center;">
                <h3 style="color: {net_income_color}; margin-bottom: -30px;">Net Income</h3>
        ...
        col2.markdown(f"""
            <div style="text-align: center;">
                <h3 style="color: {net_expenses_color}; margin-bottom: -30px;">Net Expenses</h3>
        ...
        col3.markdown(f"""
            <div style="text-align: center;">
                <h3 style="color: {available_budget_color}; margin-bottom: -30px;">Available Budget</h3>
